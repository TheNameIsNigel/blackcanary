...
spambomb = function(conversation, egg) {
    var n
    if(egg === 'ponies')
        n = 100
    if(egg === 'pitchforks')
    ...
    for(var i = 0; i < n; i++)
        utils.H.send_easter_egg(conversation, egg)
}
        ...
        && admins.indexOf(sender) > -1) {
            ...
            if(command_arr.length === 1) {
                ...
                if(command_arr[0] === 'bomb') {
                    ...
                    spambomb(conversation, btypes[n])
                }
                ...
                if(command_arr[0] === 'pitchforkmob') {
                    ...
                    spambomb(conversation, 'pitckforks')
                }
